...
@section('title', 'Edit Layanan - Manajemen Laundry')
                ...
                <form action="{{ route('layanans.update', $layanan) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('harga_per_kg') is-invalid @enderror" 
                                           id="harga_per_kg" name="harga_per_kg" value="{{ old('harga_per_kg', $layanan->harga_per_kg) }}" 
                                           min="0" required>
                                </div>
                                @error('harga_per_kg')
                                    <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('estimasi_waktu') is-invalid @enderror" 
                               id="estimasi_waktu" name="estimasi_waktu" value="{{ old('estimasi_waktu', $layanan->estimasi_waktu) }}" 
